...
void Main_controller__main_ctrlr0_step(int c_img_e, int c_img_r,
                                       ...
                                       int prio_t1, int prio_t10,
                                       int prio_t11, int prio_t2,
                                       int prio_t3, int prio_t4, int prio_t5,
                                       int prio_t6, int prio_t7, int prio_t8,
                                       int prio_t9, int rb_e, int rb_r,
                                       int rp_1, int rp_2, int rp_3,
                                       int rpl_e, int rpl_r, int rs_e,
                                       int rs_r, int sl_e, int sl_r,
                                       int texe1, int texe10, int texe11,
                                       int texe2, int texe3, int texe4,
                                       int texe5, int texe6, int texe7,
                                       int texe8, int texe9, int tl_e,
                                       int tl_r, int trk_e, int trk_r,
...
void Main_controller__main_ctrlr10_step(Main__version_type c_c_img_ver,
                                        ...
                                        int prio_t1, int prio_t10,
                                        int prio_t11, int prio_t2,
                                        int prio_t3, int prio_t4,
                                        int prio_t5, int prio_t6,
                                        int prio_t7, int prio_t8,
                                        int prio_t9, int rb_e, int rb_r,
                                        int rp_1, int rp_2, int rp_3,
                                        int rpl_e, int rpl_r, int rs_e,
                                        int rs_r, int sl_e, int sl_r,
