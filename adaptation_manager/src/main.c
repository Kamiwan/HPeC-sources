...
void Main__main_step(int prio_t1, int prio_t2, int prio_t3, int prio_t4,
  ...
  Main_controller__main_ctrlr0_step(c_img_e, c_img_r, self->ck, self->ck_10,
                                    ...
                                    self->pref_ver_task_guarantee_9_1,
                                    prio_t1, prio_t10, prio_t11, prio_t2,
                                    prio_t3, prio_t4, prio_t5, prio_t6,
                                    prio_t7, prio_t8, prio_t9, rb_e, rb_r,
  ...
  Main_controller__main_ctrlr10_step(c_c_img_ver, c_dt_ver, c_img_e, c_img_r,
                                     ...
                                     rp_1, rp_2, rp_3, rpl_e, rpl_r, rs_e,
                                     rs_r, sl_e, sl_r, texe1, texe10, texe11,
                                     texe2, texe3, texe4, texe5, texe6,
                                     texe7, texe8, texe9, tl_e, tl_r, trk_e,
                                     trk_r,
